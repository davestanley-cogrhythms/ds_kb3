...
function [wrkspc_buffer, group] = Fg_4_00_raw_pls(wrkspc_buffer,curr_stage_sfc,curr_stage_sp,opts_exclude,legend_name)
%%

    % SFC mode
    sfc_mode = 22.40131110;
    perm_mode = 22.40131110;
    % sfc_mode =  2.3515111;
    % perm_mode = 2.3015111;
    % perm_mode = 5;
    % sfc_mode = 41.6514111;
