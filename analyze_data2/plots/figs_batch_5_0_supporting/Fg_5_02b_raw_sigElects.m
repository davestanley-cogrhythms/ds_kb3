...
function [wrkspc_buffer, out] = Fg_5_02b_raw_sigElects(wrkspc_buffer,s,opts_exclude,opts_pls,opts_perm)
...
%             i=i+1; group(i)=grt; group(i).criteria(5)=[0]; group(i).ctgs=5;   % Ctg1-2 non-deciders
        ...
        case 3
            ...
            i=i+1; group(i)=grt; group(i).criteria(i1)=[1]; group(i).ctgs=9;   % Ctg1-2 non-deciders
            ...
            i=i+1; group(i)=grt; group(i).criteria(i1)=[0]; group(i).ctgs=9;   % Ctg1-2 non-deciders
            ...
            i=i+1; group(i)=grt; group(i).criteria(i2)=[1]; group(i).ctgs=10;  % Ctg1-2 non-deciders
            ...
            i=i+1; group(i)=grt; group(i).criteria(i2)=[0]; group(i).ctgs=10;  % Ctg1-2 non-deciders
%             i=i+1; group(i)=grt; group(i).criteria(5)=[1]; group(i).ctgs=5;   % Ctg1-2 non-deciders
%             i=i+1; group(i)=grt; group(i).criteria(5)=[0]; group(i).ctgs=5;   % Ctg1-2 non-deciders
