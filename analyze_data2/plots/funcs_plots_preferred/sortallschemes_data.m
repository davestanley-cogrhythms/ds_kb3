...
function [src, ssc, sfc, ns] = sortallschemes_data(src,ssc,sfc,ns,N_ctgs_base,N_ctgs_extra)
    ...
    if plot_debug
        ...
        subplotsq(3,2);plot(squeeze(mean(sfc(:,:,[1:2]),2))); title('SFC')
   ...
   % Units STD
    ...
    % SFC traces
    sfc = sortindex_all(sfc,ctg1dom,ctg3dom,N_pairs_base,N_pairs,ctgs_pairs,dom);
