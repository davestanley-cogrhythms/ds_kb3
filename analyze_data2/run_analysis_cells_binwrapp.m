...
function run_analysis_cells_binwrapp(varargin)
...
%        mcc -R -singleCompThread -mv -o run_analysis_cells_binwrapp run_analysis_cells_binwrapp.m -R -nodisplay   % (For serial)
