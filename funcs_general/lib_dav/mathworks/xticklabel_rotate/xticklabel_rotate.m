...
if strcmp(xAxisLocation,'bottom')  
    ...
    if rot == 90        % Hack to get it to stop shrinking axis for 90 degree roatation
        newpos = [origpos(1) ...
            origpos(2) - (-(min(leftdist,labyorigpos(1)))+labyorigpos(1)-largest )...
            origpos(3) ...
            origpos(4)-(min(leftdist,labyorigpos(1)))+labyorigpos(1)-largest]  ;
    end
else
    newpos = [origpos(1)-(min(leftdist,labyorigpos(1)))+labyorigpos(1) ...
            origpos(2) ...
