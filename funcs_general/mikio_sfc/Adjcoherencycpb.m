function [C,phi,S12,S1,S2,f,zerosp,confC,phistd,Cerr]=Adjcoherencycpb(data1,data2,params,fscorr,t,StarRate,rate)
...
if nargout==10; 
  if fscorr==1; 
     [confC,phistd,Cerr]=Adjcoherr(C,J1,J2,err,trialave,[],Nsp2,c0,rate); 
  else
     [confC,phistd,Cerr]=Adjcoherr(C,J1,J2,err,trialave,[],[],c0,rate); 
  end;
elseif nargout==9;
  if fscorr==1; 
     [confC,phistd]=Adjcoherr(C,J1,J2,err,trialave,[],Nsp2,c0,rate); 
  else
     [confC,phistd]=Adjcoherr(C,J1,J2,err,trialave,[],[],c0,rate); 
  end;
end;
clear Msp2
