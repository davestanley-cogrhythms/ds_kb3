function [C,phi,S12,S1,S2,f,zerosp,confC,phistd,Cerr]=Adjcoherencypb(data1,data2,params,fscorr,Adjrate1,rate1,Adjrate2,rate2)
...
a1 = Adjrate1/rate1;
a2 = Adjrate2/rate2;
recipk1 = sqrt((1-a1)*rate1./S1./a1+1);
recipk2 = sqrt((1-a2)*rate2./S2./a2+1);
C12=S12./sqrt(S1.*S2)./recipk1./recipk2;
C=abs(C12);
% C12=S12./sqrt(S1.*S2);
%========================
C=abs(C12);
...
if nargout==10; 
            ...
            %======Modified by M. Aoi 12/8/2014===================

    if fscorr==1; 
       [confC,phistd,Cerr]=Adjcoherr2(C,J1,J2,err,trialave,Nsp1,Nsp2,a1,a2);
    else
       [confC,phistd,Cerr]=Adjcoherr2(C,J1,J2,err,trialave,[],[],a1,a2);
    end;
elseif nargout==9;
    if fscorr==1; 
        [confC,phistd]=Adjcoherr2(C,J1,J2,err,trialave,Nsp1,Nsp2,a1,a2);
    else
        [confC,phistd]=Adjcoherr2(C,J1,J2,err,trialave,[],[],a1,a2);
    end;
                %============================================
