function [confC,phistd,Cerr]=Adjcoherr2(C,J1,J2,err,trialave,numsp1,numsp2,a1,a2)
...
elseif errchk==2;
    ...
    for k=1:dim;
        ...
        recipk1 = sqrt((1-a1)*rate1./eJ1k./a1+1);
        recipk2 = sqrt((1-a2)*rate2./eJ2k./a2+1);
        Cxyk=eJ12k./sqrt(eJ1k.*eJ2k)./recipk1./recipk2;
